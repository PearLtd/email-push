...
export PATH=$PATH:$TOOLCHAIN_PATH/usr/lib
...
sudo echo "export CHROOT=./sdk_package" >> $TOOLCHAIN_PROFILE
sudo echo "export TOOLCHAIN_PATH=$CHROOT/toolchain" >> $TOOLCHAIN_PROFILE
sudo echo "export PATH=$PATH:$TOOLCHAIN_PATH/usr/lib" >> $TOOLCHAIN_PROFILE
